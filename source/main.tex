...
\usepackage{colortbl}
\usepackage{multirow}
\newcolumntype{C}{>{\columncolor[gray]{.93}}c}
\newcolumntype{L}{>{\columncolor[gray]{.93}}l}
\newcolumntype{R}{>{\columncolor[gray]{.93}}r}
...
\title{Letters from the Stochastic Penal Colony \protect \emo{desertisland}}
