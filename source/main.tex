...
% Phew!
\newcommand\DDAALLEE{\texorpdfstring{DALL\raisebox{0.2ex}{•}E}{DALL•E}}
%\newcommand\DALLE{$\textsc{dall}\raisebox{0.18ex}{\scalebox{0.6}{$\bullet$}}\textsc{e}$}
...
\keywords{\AI\ image generator, child sexual abuse material, content moderation,
    \textsc{dall}•\textsc{e}, generative model, governance, harm reduction,
    Kafkaesque co-factor, punitive algorithm, social media, text-to-image tool,
