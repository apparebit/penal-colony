\section{Policy and Terms of Use for \DDAALLEE\ 2}
...
September 19, 2022 by rewording the rules on disclosing the role of \V{AI} and by
...
Thank you for trying our generative \V{AI} tools!
...
\item[Disclose the role of \V{AI}.] \hfill

    \begin{itemize}
    \item You must clearly indicate that images are \V{AI}-generated---or which
...
\item \textbf{Improving \V{AI} safety and technologies.} You grant us all rights
    to use your Prompts and Uploads to improve our \V{AI} safety efforts, and to
    develop and improve our \V{AI} technologies, products, and services. As part
