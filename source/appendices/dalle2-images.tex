\section{\DDAALLEE\ 2 Imagines the Penal Colony}
...
\begin{minipage}[t]{0.49\textwidth}
    \centering
    %\vspace{2em}
    \includegraphics[width=1.0\textwidth]{han-solo-behind-bars}
...
\begin{minipage}[t]{0.49\textwidth}
    \centering
    %\vspace{2em}
    \includegraphics[width=1.0\textwidth]{leia-vader-bacon}
...
\begin{minipage}[t]{0.49\textwidth}
    \centering
    %\vspace{2.5em}
    \includegraphics[width=1.0\textwidth]{leia-vader-hopper}
...
\begin{minipage}[t]{0.49\textwidth}
    \centering
    %\vspace{2.5em}
    \includegraphics[width=1.0\textwidth]{crimson-pope}
...
\begin{minipage}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{robot-surgeon}
...
\begin{minipage}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{screaming}
...
\begin{minipage}[t]{0.49\textwidth}
    \centering
    %\vspace{1.5em}
    \includegraphics[width=1.0\textwidth]{falling-over}
...
\begin{minipage}[t]{0.49\textwidth}
    \centering
    %\vspace{1.5em}
    \includegraphics[width=1.0\textwidth]{mouth-pulled-open}
...
\begin{minipage}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{sarcophagus}
...
\begin{minipage}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{skull-and-knife}
