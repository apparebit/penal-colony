...
Appendix~\ref{sec:dalle2:contentpolicy} on
page~\pageref{sec:dalle2:contentpolicy}). Let's see whether the policy is of
...
reproduced in Appendix~\ref{sec:dalle2:terms} on
page~\pageref{sec:dalle2:terms}), the firm retains ownership of all generated
...
As shown in Appendix~\ref{sec:dalle2:contentpolicy} on
page~\pageref{sec:dalle2:contentpolicy}, \DALLE's content policy comes right out
