...
selection in Appendix~\ref{sec:dalle:images} on
page~\pageref{sec:dalle:images}. Four images depict people in prison,
...
in Appendix~\ref{sec:dalle:images} is dated November 15, 2022. By
...
selection in Appendix~\ref{sec:dalle:images}: \DALLE's enforcer
...
Appendix~\ref{sec:chatgpt} on page~\pageref{sec:chatgpt} chronicles my two
